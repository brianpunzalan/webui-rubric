...
export { checkHeadingOrder, checkLandmarkUsage, checkLinkDescriptiveness, checkImageAlt, checkFormLabels, checkMetaViewport } from './structural/dom-checks.js';
export { checkUniqueColorCount, checkFontFamilyCount, checkSpacingConsistency } from './structural/css-checks.js';
...
export { runPixelmatch, type PixelComparisonInput, type PixelComparisonOutput } from './pixelmatch/index.js';
export { scoreFromDiffRatio } from './pixelmatch/scoring.js';
export { runMultiViewportComparison, type ViewportComparisonInput } from './pixelmatch/multi-viewport.js';
